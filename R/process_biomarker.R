...
#'
#'
#' @param biomarker_tbl A tibble with columns, c('person_id', 'start_date', 'measurement_date', 'end_date', 'measurement_concept_id', 'value_as_number')
#' @param biomarker_name A string, e.g., "LDL cholesterol"
#' @param covariates_flagged A tibble with columns, c('person_id','dob','gender_concept_id','race_concept_id','start_date','first_drug_exposure','final_end_date','age','drug_exposed','treatment_new_exposed')
#' @param baseline_cols A vector, e.g. c('person_id', 'start_date', 'first_drug_exposure', 'final_end_date')
#' @param inclusion_cols A vector, e.g., c('person_id', 'measurement_date', 'measurement_concept_id', 'value_as_number')
